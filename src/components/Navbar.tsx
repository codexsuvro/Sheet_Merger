...
const Navbar = () => {
    ...
    return (
        <div className={`h-[12vh] w-full shadow-2xl flex justify-between items-center bg-white ${location.pathname === `/` ? `fixed top-0 left-0 z-50` : `fixed top-0 left-0 z-50`} `}>
            ...
            <div className={`flex pl-4 pr-8 gap-8 py-2 w-auto`}>
                {location.pathname === "/" ? <Link to="/onlypreview">
                    <TableViewIcon fontSize="large" className="cursor-pointer" />
                </Link> : <Link to="/">
